...
@.str.2 = private unnamed_addr constant [30 x i8] c"op is not both load and store\00", align 1
...
if.then.24:                                       ; preds = %for.body.15
  ...
  %call25 = call i32 @strcmp(i8* %15, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)) #4
...
if.else.56:                                       ; preds = %if.then.24
  ...
  %call57 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0)) #4
...
if.else.100:                                      ; preds = %if.else.56
  %call101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0))
  br label %if.end.102
...
if.then.108:                                      ; preds = %land.lhs.true
  ...
  %call121 = call i32 @strcmp(i8* %66, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)) #4
...
if.else.141:                                      ; preds = %if.then.108
  ...
  %call142 = call i32 @strcmp(i8* %76, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0)) #4
...
if.else.162:                                      ; preds = %if.else.141
  %call163 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0))
  br label %if.end.164
...
if.then.174:                                      ; preds = %land.lhs.true.172
  ...
  %call192 = call i32 @strcmp(i8* %98, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)) #4
...
if.else.210:                                      ; preds = %if.then.174
  ...
  %call211 = call i32 @strcmp(i8* %106, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0)) #4
...
if.else.229:                                      ; preds = %if.else.210
  %call230 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0))
  br label %if.end.231
